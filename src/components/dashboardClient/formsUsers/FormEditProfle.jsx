								...
								<div className=''>
									<div className='flex justify-start'>
										<div className='w-1/5 inline-block mt-4'>
											<label className='flex h-[43.2px] py-2 px-4 mt-4'>
												Email
											</label>
											<label className='flex h-[43.2px] py-2 px-4 mt-4'>
												First Name*
										...
										<div className='w-2/5 inline-block mt-4'>
											<span className='flex font-bold py-2 px-4 mt-4'>
												{redUser?.email}
											</span>
											<Field
                    ...
                    /> */}
									...
									<div className='flex justify-start mt-8 '>
										<Link to={`/${id}/user/menu/account`}>
											<button
												className='btn btn-red hover:btn-red w-32 ml-16'
												value='Back'
											>
												Back
											</button>
										...
										<button
											type='submit'
											value='Save'
											className='btn btn-purple hover:btn-purple w-32 ml-16'
										>
											Save
										</button>
									</div>
