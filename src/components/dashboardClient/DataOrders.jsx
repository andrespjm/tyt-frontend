                    ...
                    {!!e?.OrderItems?.length > 0 && e?.OrderItems?.map((o, k) => {
                      return (
                        <div key={k} className='flex m-3' >
                          ...
                          <div className='w-28 h-28 flex justify-center justify-items-center overflow-hidden  rounded-xl'><img className='w-full object-cover' src={o?.Stock?.Product?.img_home?.secure_url} /></div>
