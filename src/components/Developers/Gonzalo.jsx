			...
			<div id='gonzalo' className='card' data-state='#gonzalo-about'>
				<div className='card-header'>
					...
					<img
						...
						src='https://i.ibb.co/ZGd3VQt/Image.jpg'
						alt='avatar'
					/>
				...
				<div className='card-main'>
					...
					>
						...
						<div className='card-social'>
							<a
								href='https://www.facebook.com/gonzalo.correa.g/'
								target='_blank'
								rel='noreferrer'
							>
							...
							<a
								href='https://twitter.com/GonzaloCorreaG'
								target='_blank'
								rel='noreferrer'
							>
							...
							<a
								href='https://github.com/Gonza10Co'
								target='_blank'
								rel='noreferrer'
							>
								<svg
							...
							<a
								href='https://www.linkedin.com/in/gonzalo-correa-g/'
								target='_blank'
								rel='noreferrer'
							>
								<svg viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
							...
							<div className='card-timeline'>
								<div className='card-item' data-year='2010'>
									<div className='card-item-title'>
										Head Trader at <span>Banco Itaú</span>
									</div>
									<div className='card-item-desc'>
										Lead the Trading Team of the FX Desk, designing, monitorin
										and executing investments strategies.
									</div>
								</div>
								<div className='card-item' data-year='2020'>
									<div className='card-item-title'>
										Trading and Sales Cheaf at <span>Bancoldex</span>
									</div>
									<div className='card-item-desc'>
										Lead the Trading and Sales Team. Develop new products to
										reduce the cost of funding of the Bank.
									</div>
								</div>
